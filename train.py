...
def main():
    ...
    parser.add_argument('--arch', type=str, default='resnet18', help='Architecture [resnet18, vgg16]')
    ...
    if args.arch == 'resnet18':
        ...
        model.fc = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.5),
            nn.Linear(args.hidden_units, len(train_datasets.classes)),
            nn.LogSoftmax(dim=1)
        )
    ...
    checkpoint = {
        ...
        'classifier': model.fc if args.arch == 'resnet18' else model.classifier  # Save the classifier layer
    }
