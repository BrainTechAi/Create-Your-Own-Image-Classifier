...
def load_checkpoint(filepath):
    ...
    arch = checkpoint.get('architecture', 'resnet18')  # Default to 'resnet18' if not found
...
def main():
    parser = argparse.ArgumentParser(description='Predict top K classes of an image.')
